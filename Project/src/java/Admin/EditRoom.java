...
public class EditRoom extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Model.Room> room = db.getRooms();
        Room r = new Room();
        ...
        if (r.info(id_raw) != null) {
            request.setAttribute("roomtype", db.getRoomType());
            request.setAttribute("room", r.info(id_raw));
        }
        else{
              request.getRequestDispatcher("Room").forward(request, response);
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        DBContext db = new DBContext();
        db.UpdateRoom(roomnumber, status, Integer.parseInt(typeid));
